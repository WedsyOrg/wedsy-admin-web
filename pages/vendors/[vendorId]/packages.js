    ...
    <>
      <div className="flex flex-col gap-6 p-8">
        <div className="grid grid-cols-4 gap-4 items-end">
          ...
          <VendorHeaderDropdown display={"Packages"} vendorId={vendorId} />
        </div>
        ...
        <div className="grid grid-cols-6 gap-4">
          <StatsCard title={"Packages Received"} value={"50"} />
          <StatsCard title={"Packages Accepted"} value={"20"} />
          <StatsCard title={"Packages Done"} value={"10"} />
          <StatsCard title={"Packages Rejected"} value={"10"} />
          <div />
          <div className="flex flex-col gap-2 justify-between py-3">
            <div className="bg-white rounded-lg border py-2 px-6 text-center flex flex-row gap-2 justify-between">
          ...
          <div className="width-full overflow-x-auto">
            <Table hoverable className="width-full overflow-x-auto">
              <Table.Head>
                ...
                <Table.HeadCell>No.of People</Table.HeadCell>
